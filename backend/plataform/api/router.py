...
pedido_router.register(r"proposta", views.PropostaPedidoViewSet, basename="proposta-pedido", parents_query_lookups=["pedido"])
pedido_router.register(r"minhas-propostas", views.MinhasPropostasPedidoViewSet, basename="proposta-freteiro", parents_query_lookups=["pedido"])
